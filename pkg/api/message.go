...
func NewMessageChatApi(param MessageChatApiParam) *Api {
	return &Api{
		Method: "POST",
		Path:   "/message/chat/",
		Handler: WrapperFunc(func(ctx context.Context, req *MessageChatRequest) (*MessageChatResponse, error) {
			return nil, nil
		}),
	}
}
...
func NewMessageActionApi(param MessageActionApiParam) *Api {
	return &Api{
		Method: "POST",
		Path:   "/message/action/",
		Handler: WrapperFunc(func(ctx context.Context, req *MessageActionRequest) (*MessageActionResponse, error) {
			return nil, nil
		}),
	}
}
